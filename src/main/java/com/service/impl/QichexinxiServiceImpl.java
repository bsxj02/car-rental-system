...
public class QichexinxiServiceImpl extends ServiceImpl<QichexinxiDao, QichexinxiEntity> implements QichexinxiService {
    ...
    @Override
    public List<Map<String, Object>> selectValue(Map<String, Object> params, Wrapper<QichexinxiEntity> wrapper) {
        return baseMapper.selectValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params, Wrapper<QichexinxiEntity> wrapper) {
        return baseMapper.selectTimeStatValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectGroup(Map<String, Object> params, Wrapper<QichexinxiEntity> wrapper) {
        return baseMapper.selectGroup(params, wrapper);
    }


    @Override
    public List<Map<String, Object>> qichemingchengqichezhuangtaiTypeStat(Map<String, Object> params, Wrapper<QichexinxiEntity> wrapper) {
        return baseMapper.qichemingchengqichezhuangtaiTypeStat(params, wrapper);
    }
